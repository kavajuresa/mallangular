...
<body onload="goDoc()">
  ...
  <div class="container-fluid mt70 plr15">
    ...
    <ul>
      ...
      <li>
        Setting <a>GraphObject.segmentIndex</a> to NaN, which was previously an error, will now treat the entire link path as the segment
        for the purpose of <a>GraphObject.segmentFraction</a>. This allows for getting fractional distances along the entire link.
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        CTRL + Mouse-wheel will still stop the event from bubbling, even if <a>CommandHandler.canIncreaseZoom</a> or <a>CommandHandler.canDecreaseZoom</a>
        are false.
